...
window['SEASONS_wolfsburg-pep'] = [
  ...
  /* ─── SAISON 2026/27 · EN COURS ──────────────────────── */
  {
    ...
    scorers: [
      ...
      { name: "Mohamed Amoura",    detail: "BU · Algérien · 26 ans", value: 3 },
      { name: "Kento Shiogai",     detail: "BU · Japonais · 21 ans", value: 2 },
    ],
    assists: [
      { name: "Lovro Majer · Christian Eriksen", detail: "MOC · ex-aequo", value: 4 },
      { name: "Wimmer · Bürger · Vavro", detail: "AD / DD / DC · ex-aequo", value: 1 },
    ],
    ratings: [
      { name: "Jan Bürger",        detail: "DD · 1 tit. / 6 rempl. · 1 passe D.", value: 7.27 },
      { name: "Maximilian Arnold", detail: "MDC · 13 tit. · 1 but", value: 7.15 },
      { name: "Patrick Wimmer",    detail: "AD · 9 tit. · 1 but · 1 passe D.", value: 7.00 },
    ],
    flops: [
      { name: "Aster Vranckx",     detail: "MC · Belge · 24 ans · 8 tit. / 4 rempl. · 1 but", value: 6.44 },
      { name: "Lovro Majer",       detail: "MOC · Croate · 28 ans · 18 tit. · 4 passes D.", value: 6.49 },
      { name: "Christian Eriksen", detail: "MOC · Danois · 34 ans · 18 tit. · 1 but · 4 passes D.", value: 6.54 },
    ],
    ...
    cup2: {
      ...
      phase: "Phase de championnat : 9e sur 36 · 3V 1N 1D · 10 pts",
      rounds: [
    ...
    standings: [
      { pos:1,  team:"Bayern München",      j:13, g:9, n:2, l:2, bp:23, bc:8,  db:15, pts:29, zone:"promo" },
      { pos:2,  team:"Stuttgart",           j:13, g:8, n:4, l:1, bp:22, bc:11, db:11, pts:28, zone:"promo" },
      { pos:3,  team:"Union Berlin",        j:14, g:8, n:1, l:5, bp:15, bc:15, db: 0, pts:25, zone:"promo" },
      { pos:4,  team:"Eintracht Frankfurt", j:13, g:6, n:6, l:1, bp:23, bc:9,  db:14, pts:24, zone:"promo" },
      { pos:5,  team:"RB Leipzig",          j:13, g:4, n:8, l:1, bp:18, bc:11, db: 7, pts:20 },
      { pos:6,  team:"Freiburg",            j:13, g:6, n:2, l:5, bp:17, bc:12, db: 5, pts:20 },
      { pos:7,  team:"Heidenheim",          j:13, g:5, n:4, l:4, bp:14, bc:14, db: 0, pts:19 },
      { pos:8,  team:"Dortmund",            j:13, g:5, n:4, l:4, bp:13, bc:13, db: 0, pts:19 },
      { pos:9,  team:"Bayer Leverkusen",    j:13, g:5, n:3, l:5, bp:12, bc:13, db:-1, pts:18 },
      { pos:10, team:"Mainz 05",            j:14, g:4, n:5, l:5, bp:12, bc:13, db:-1, pts:17 },
      { pos:11, team:"Hertha",              j:13, g:5, n:2, l:6, bp:13, bc:16, db:-3, pts:17 },
      { pos:12, team:"Hamburg",             j:13, g:4, n:5, l:4, bp:6,  bc:9,  db:-3, pts:17 },
      { pos:13, team:"FC Köln",             j:13, g:3, n:7, l:3, bp:8,  bc:10, db:-2, pts:16 },
      { pos:14, team:"Hoffenheim",          j:13, g:3, n:3, l:7, bp:15, bc:21, db:-6, pts:12 },
      { pos:15, team:"Wolfsburg",           j:13, g:3, n:2, l:8, bp:10, bc:16, db:-6, pts:11, highlight:true },
      { pos:16, team:"Holstein Kiel",       j:13, g:1, n:7, l:5, bp:7,  bc:15, db:-8, pts:10 },
      { pos:17, team:"Gladbach",            j:13, g:2, n:4, l:7, bp:10, bc:23, db:-13,pts:10 },
      { pos:18, team:"Hannover",            j:13, g:0, n:5, l:8, bp:3,  bc:12, db:-9, pts:5, zone:"releg" },
    ],
